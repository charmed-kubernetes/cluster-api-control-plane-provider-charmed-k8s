...
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=jujucontrolplanes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=jujucontrolplanes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=jujucontrolplanes/finalizers,verbs=update
